...
app.controller('mainCtrl', ['$rootScope', '$scope', '$http', '$timeout',
    function ($rootScope, $scope, $http, $timeout) {
        ...
        $scope.run = function () {
            ...
            $http.get('kuis1/questions.php').success(function (response) {
            ...
            $scope.submit = function () {
                if ($scope.position === $scope.questions.length - 1) {
                    console.log('submit');
                    $http.post('kuis1/submit.php', $scope.answers).success(function (response) {
